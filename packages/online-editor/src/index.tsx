...
if (!urlParams.has("ext")) {
  ReactDOM.render(
    <App iframeTemplateRelativePath={"envelope/index.html"} file={emptyFile} modifiable={true} />,
...
window.addEventListener("loadOnlineEditor", (e: CustomEvent) => {
  ...
  ReactDOM.render(
    <App iframeTemplateRelativePath={"envelope/index.html"} file={file} modifiable={e.detail.modifiable} />,
    document.getElementById("app")!
  );
});
